...
async def generate_session(bot: Client, msg: Message, telethon=False, is_bot: bool = False):
    ...
    text = f"**هذا هو {ty} كـود جلسـة** \n\n`{string_session}` \n\n**مستخـرج مـن :** @Xo12obot\n🍒 **ملاحظـة :** لا تشارك الكود لأحـد لأنـه يستطيع اختراق حسابك من خلالـه قنـاة السورس @uwrwe ."
    try:
        if not is_bot:
